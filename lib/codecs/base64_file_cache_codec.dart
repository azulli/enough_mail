...
mixin Base64FileCacheCodec on MailCodec {
  Future<void> encodeFileToFile(File sourceFile, File destFile) async {
  ...
  Future<void> decodeFileFromFile(File sourceFile, File destFile) async {
    var cacheSink = destFile.openWrite();
