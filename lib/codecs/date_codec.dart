   ...
   */
    ...
    if (zoneText.length != 5) {
      if (zoneText.length == 4 &&
        ...
        var timeZonesByName = <String, String>{
          'GMT':
          ...
          'AET':
              '+1000', // 	Australian Eastern Time - can also apparently be +1100
          ...
          'AST':
              '+0300', // Arabia Standar Time, could also be Atlantic Standard Time
          ...
          'CWST':
              '+0845', // Central Western Standard Time (Australia) unofficial
          ...
          'ECT':
              '-0500', //  Ecuador Time, could also be Eastern Caribbean Time -0400
